    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<ServiceResponse<string>> Login(UserLoginDTO loginDTO)
        {
            ...
            if (user.Status != Enums.Status.Active)
                return new ServiceResponse<string>() { Data = ResourceHelper.GetResource("NotActiveUserLoginError") };
            ...
            {
                response.Success = false;
                response.Message = ResourceHelper.GetResource(Constants.UserNotFound);
                return response;
            }
